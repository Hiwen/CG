...
namespace DMS.CG
{
	...
	{
		private static readonly HashSet<string> s_keywords = ParseTokens(Resources.cgKeywords);
		private static readonly HashSet<string> s_functions = ParseTokens(Resources.cgFunctions);
		private static readonly HashSet<string> s_variables = ParseTokens(Resources.cgVariables);
